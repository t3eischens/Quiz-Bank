			...
			<div class="card" style="margin-top:50px;margin-bottom: 100px;">
                ...
                <form method="post" id="user_register_form">
                  <div class="form-group">
                    ...
                    <input type="text" name="user_email_address" id="user_email_address" class="form-control" data-parsley-checkemail data-parsley-checkemail-message='Email Address Exists' />
                  </div>
                  <div class="form-group">
